...
function openModal(index) {
    ...
    let modalTemplate = `<div class="modal-window">
    <div class="cross-btn" onclick="closeModal()">
    <img src="./assets/icons/cross.png" alt="close">
    </div>
    <div class="modal-window--wrapper">
        <div class="modal-window--img">
            <img src="${pets[index].img}" alt="${pets[index].name}" class="modal-window__image-img">
        </div>
        <div class="modal-window--text">
            <h2>${pets[index].name}</h2>
            <h3>${pets[index].type} - ${pets[index].breed}</h3>
            <p>${pets[index].description}</p>
            <ul>
                <li><span>Age:</span> ${pets[index].age}</li>
                <li><span>Inoculations:</span> ${pets[index].inoculations.join()}</li>
                <li><span>Diseases:</span> ${pets[index].diseases.join()}</li>
                <li><span>Parasites:</span> ${pets[index].parasites.join()}</li>
            </ul>
        </div>
    </div>
</div>`;
